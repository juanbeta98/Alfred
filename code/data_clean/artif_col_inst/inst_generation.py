...
instance = 'inst3'
directorio_df, labors_raw_df, cities_df, duraciones_df, valid_cities = load_tables(data_path, generate_labors=True)
...
labors_inst_df.to_csv(f'{data_path}/data_clean/artif_col_inst/{instance}/labors_{instance}_df.csv',index=False)
