...
labors_filtered_df = filter_invalid_services(labors_raw_df, min_delay_minutes=0)
...
hist_directory.to_csv(os.path.join(out_dir, "directorio_hist_df.csv"), index=False)
